...
class LeftPanel extends React.Component {
    ...
    render() {
      return (
          <div className='leftPanelPage'>
          <div className='leftContainer'>
                <img alt="" width="260" height="260" src={this.state.personDetails.avatar_url}/>
                <div>{this.state.personDetails.name}</div>
                <div>{this.state.personDetails.login}</div>
                <div>{this.state.personDetails.bio}</div>
                ...
                {this.state.personDetails.company}</div>
                <div>
                ...
                {this.state.personDetails.location}</div>
                <div>
                ...
                {this.state.personDetails.login}@gmail.com</div>
          </div>
